...
import PyjamaCode.TestingClauses.Schedule.schedule_positive_test3;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Schedule_Group5Test {
	...
	public static void tearDownAfterClass() throws Exception {
		...
		n.write(Data, "JsonResult", "Schedule", "CorrectnessJunitResults_Group5", false);
	}
	
	@Test
	public void ScheduleTest1() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case1");
		int threadNumber = 2;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=10;
		result.setArraySize(arraySize);
		//int chunkSize=4;
		
		int[] actualArray = test.parallel_for_schedule(threadNumber, arraySize);
	...
	public void ScheduleTest2() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case2");
		int threadNumber = 3;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=10;
	...
	public void ScheduleTest3() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case3");
		int threadNumber = 4;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=10;
	...
	public void ScheduleTest4() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case4");
		int threadNumber = 5;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=10;
	...
	public void ScheduleTest5() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case5");
		int threadNumber = 2;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=100;
	...
	public void ScheduleTest6() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case6");
		int threadNumber = 3;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=100;
	...
	public void ScheduleTest7() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case7");
		int threadNumber = 4;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=100;
	...
	public void ScheduleTest8() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case8");
		int threadNumber = 5;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=100;
	...
	public void ScheduleTest9() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case9");
		int threadNumber = 2;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=1000;
	...
	public void ScheduleTest10() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case10");
		int threadNumber = 3;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=1000;
	...
	public void ScheduleTest11() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case11");
		int threadNumber = 4;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=1000;
	...
	public void ScheduleTest12() {
		schedule_positive_test3 test = new schedule_positive_test3();
		Result result = new Result();
		result.setTestName("Guided_Case12");
		int threadNumber = 5;
		result.setThreadCount(threadNumber);
		result.setChunkSize("Default");
		int arraySize=1000;
