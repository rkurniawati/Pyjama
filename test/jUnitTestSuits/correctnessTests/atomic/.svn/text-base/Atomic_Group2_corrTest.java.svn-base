...
import PyjamaCode.TestingDirectives.Atomic.atomic_positive_test2;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Atomic_Group2_corrTest {
	...
	public void atomicTest1() {
		...
		atomic_positive_test2 test = new atomic_positive_test2();
