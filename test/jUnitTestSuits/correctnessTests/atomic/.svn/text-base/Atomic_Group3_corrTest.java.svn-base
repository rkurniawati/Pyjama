...
import PyjamaCode.TestingDirectives.Atomic.atomic_positive_test3;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Atomic_Group3_corrTest {
	...
	public void atomicTest1() {
		...
		atomic_positive_test3 test = new atomic_positive_test3();
