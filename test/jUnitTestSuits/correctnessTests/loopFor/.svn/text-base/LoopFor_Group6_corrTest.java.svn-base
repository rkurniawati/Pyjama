...
public class LoopFor_Group6_corrTest {
	...
	public static void tearDownAfterClass() throws Exception {
		...
		n.write(Data, "JsonResult", "LoopFor", "CorrectnessJunitResults_Group6", false);
	}
	
	@Test
	public void LoopForTest1() {
		loopFor_positive_test3 test = new loopFor_positive_test3();//<
	...
	public void LoopForTest7() {
		loopFor_positive_test4 test = new loopFor_positive_test4();//<=
		Result result = new Result();
