...
import PyjamaCode.TestingLibraries.Function3.testCase_omp_get_num_threads;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Omp_get_num_threadsTest {
	...
	public static void tearDownAfterClass() throws Exception {
		...
		n.write(Data, "JsonResult", "Omp_get_num_threads", "CorrectnessJunitResults", false);
	}
	...
	public void LibraryTest1() {
		...
		testCase_omp_get_num_threads test = new testCase_omp_get_num_threads();
		Result result = new Result();
		result.setTestName("Omp_get_num_threads_Case1");
		result.setThreadCount(threadNumber);

		//
		int actual = test.omp_get_num_threads(threadNumber);
	...
	public void LibraryTest2() {
		...
		testCase_omp_get_num_threads test = new testCase_omp_get_num_threads();
		Result result = new Result();
		result.setTestName("Omp_get_num_threads_Case2");
		result.setThreadCount(threadNumber);
	...
	public void LibraryTest3() {
		...
		testCase_omp_get_num_threads test = new testCase_omp_get_num_threads();
		Result result = new Result();
		result.setTestName("Omp_get_num_threads_Case3");
		result.setThreadCount(threadNumber);
	...
	public void LibraryTest4() {
		...
		testCase_omp_get_num_threads test = new testCase_omp_get_num_threads();
		Result result = new Result();
		result.setTestName("Omp_get_num_threads_Case4");
		result.setThreadCount(threadNumber);
