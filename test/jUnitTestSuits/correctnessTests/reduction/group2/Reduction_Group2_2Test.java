package jUnitTestSuits.correctnessTests.reduction.group2;
...
import PyjamaCode.TestingClauses.Reduction.reduction_positive_test2;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Reduction_Group2_2Test {
	...
	public static void tearDownAfterClass() throws Exception {
		...
		n.write(Data, "JsonResult", "Reduction","CorrectnessJunitResults_Group2", false);
	}
	...
	public synchronized void ReductionTest1() {
		...
		reduction_positive_test2 test = new reduction_positive_test2();
