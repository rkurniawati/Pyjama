package jUnitTestSuits.correctnessTests.reduction.group1;
...
import PyjamaCode.TestingClauses.Reduction.reduction_positive_test1;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Reduction_Group1_2Test {
	...
	public synchronized void ReductionTest1() {
		...
		reduction_positive_test1 test = new reduction_positive_test1();
