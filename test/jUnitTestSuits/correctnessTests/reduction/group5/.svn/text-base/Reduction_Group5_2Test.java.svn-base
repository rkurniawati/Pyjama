package jUnitTestSuits.correctnessTests.reduction.group5;
...
import PyjamaCode.TestingClauses.Reduction.reduction_positive_test5;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Reduction_Group5_2Test {
	...
	public static void tearDownAfterClass() throws Exception {
		...
		n.write(Data, "JsonResult", "Reduction","CorrectnessJunitResults_Group5", false);
	}
	...
	public synchronized void ReductionTest1() {
		...
		reduction_positive_test5 test = new reduction_positive_test5();
