package jUnitTestSuits.correctnessTests.reduction.group4;
...
import PyjamaCode.TestingClauses.Reduction.reduction_positive_test4;
import Utility.JSONDatabaseHelper.resultWriterHelper;

public class Reduction_Group4_1Test {
	...
	public static void tearDownAfterClass() throws Exception {
		...
		n.write(Data, "JsonResult", "Reduction","CorrectnessJunitResults_Group4", false);
	}
	...
	public synchronized void ReductionTest1() {
		...
		reduction_positive_test4 test = new reduction_positive_test4();
