...
public class Parallel_Group1_RtTest {
	...
	@Test
	public void parallel_region_case1() {
		int threadNumber = 2;
		Assume.assumeTrue(processNum > threadNumber - 2);
		test(threadNumber);
	}
	@Test
	public void parallel_region_case2() {
		int threadNumber = 3;
		Assume.assumeTrue(processNum > threadNumber - 2);
		test(threadNumber);
	}
	@Test
	public void parallel_region_case3() {
		int threadNumber = 4;
		Assume.assumeTrue(processNum > threadNumber - 2);
		test(threadNumber);
	}
	@Test
	public void parallel_region_case4() {
		int threadNumber = 5;
		Assume.assumeTrue(processNum > threadNumber - 2);
		test(threadNumber);
	}
	@Test
	public void parallel_region_case5() {
		int threadNumber = 6;
		Assume.assumeTrue(processNum > threadNumber - 2);
		test(threadNumber);
	}
	@Test
	public void parallel_region_case6() {
		int threadNumber = 7;
		Assume.assumeTrue(processNum > threadNumber - 2);
		test(threadNumber);
	}
	@Test
	public void parallel_region_case7() {
		int threadNumber = 8;
		Assume.assumeTrue(processNum > threadNumber - 2);
		test(threadNumber);
	}
	...
	private void test(int threadNumber){
		...
		result.setTestName("parallel_region");		
		result.setThreadCount(threadNumber);
		
		long[] runningTime =test.parallel_region(threadNumber);
