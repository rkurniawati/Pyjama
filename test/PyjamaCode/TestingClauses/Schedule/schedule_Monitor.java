package PyjamaCode.TestingClauses.Schedule;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
...
import Utility.MemoryAndCPUHelper.MonitorInfo;//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
public class schedule_Monitor {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public List<MonitorInfoBean> parallel_for_static(int threadNumber, int n) throws Exception {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int[] completeNumber = new int[] { 0 };//#GEN#[-1]#PJ#
                    ...
                    for (OMP_iterator=__omp_loop_thread_num*1; OMP_iterator<=OMP_end && 1>0; OMP_iterator=OMP_iterator+__omp_loop_num_threads*1) {
                        for (int OMP_local_iterator = OMP_iterator; OMP_local_iterator<OMP_iterator+1 && OMP_local_iterator<=OMP_end; OMP_local_iterator++){
                            ...
                            {//#GEN#[-1]#PJ#
                                ...
                                try {//#GEN#[-1]#PJ#
                                    {//#GEN#[-1]#PJ#
                                        completeNumber[0] = completeNumber[0] + 1;//#GEN#[-1]#PJ#
                                    }} finally {//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
                            try {//#GEN#[-1]#PJ#
                                service = new MonitorInfo();//#GEN#[-1]#PJ#
                                double complete = (double) completeNumber[0] / n;//#GEN#[-1]#PJ#
                                ...
                                if (complete == 1) result.add(service.getMonitorInfoBean());//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public List<MonitorInfoBean> parallel_for_dynamic(int threadNumber, int n) throws Exception {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int[] completeNumber = new int[] { 0 };//#GEN#[-1]#PJ#
        int[] array = new int[n];//#GEN#[-1]#PJ#
        MonitorInfo service = new MonitorInfo();//#GEN#[-1]#PJ#
        ...
        result = (List<MonitorInfoBean>)outputlist__OMP_ParallelRegion_1.get("result");
...
//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public List<MonitorInfoBean> parallel_for_guided(int threadNumber, int n) throws Exception {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int[] completeNumber = new int[] { 0 };//#GEN#[-1]#PJ#
        int[] array = new int[n];//#GEN#[-1]#PJ#
        MonitorInfo service = new MonitorInfo();//#GEN#[-1]#PJ#
        ...
        result = (List<MonitorInfoBean>)outputlist__OMP_ParallelRegion_2.get("result");
