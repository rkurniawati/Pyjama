...
//#GEN#[-1]#PJ#
public class schedule_RT {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public long[] parallel_for_static(int threadNumber, int n) {{//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public long[] parallel_for_dynamic(int threadNumber, int n) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        long[] RT = new long[2];//#GEN#[-1]#PJ#
        int[] array = new int[n];//#GEN#[-1]#PJ#
        RT[0] = System.currentTimeMillis();//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public long[] parallel_for_guided(int threadNumber, int n) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        long[] RT = new long[2];//#GEN#[-1]#PJ#
        int[] array = new int[n];//#GEN#[-1]#PJ#
        RT[0] = System.currentTimeMillis();//#GEN#[-1]#PJ#
