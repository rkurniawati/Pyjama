package PyjamaCode.TestingClauses.Private;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
public class private_positive_test2 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    /**
	 ...
	 * *///#GEN#[-1]#PJ#
    public int parallel_for_private(int threadNumber) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int shijun = -1;//#GEN#[-1]#PJ#
