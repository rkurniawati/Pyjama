package PyjamaCode.TestingClauses.FirstPrivate;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
public class firstPrivate_positive_test3 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public int[] parallel_single_firstPrivate(int threadNumber) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int i = threadNumber;//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#BEGIN firstprivate lastprivate reduction variables defined and initialized here
                    int OMP_WoRkShArInG_PRIVATE_i = i;
                    ...
                    while ((OMP_iterator = PjRuntime.get_OMP_loopCursor().getAndAdd(1)) <= OMP_end) {
                        for (int OMP_local_iterator = OMP_iterator; OMP_local_iterator<OMP_iterator+1 && OMP_local_iterator<=OMP_end; OMP_local_iterator++){
                            ...
                            {//#GEN#[-1]#PJ#
                                ...
                                array[index] = OMP_WoRkShArInG_PRIVATE_i;//#GEN#[-1]#PJ#
                                OMP_WoRkShArInG_PRIVATE_i = 0;//#GEN#[-1]#PJ#
