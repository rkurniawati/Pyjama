...
//#GEN#[-1]#PJ#
public class firstPrivate_positive_test1 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public int[] parallel_firstPrivate(int threadNumber) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int kk = threadNumber;//#GEN#[-1]#PJ#
        ...
        inputlist__OMP_ParallelRegion_0.put("kk",kk);
...
class _OMP_ParallelRegion_0{
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            MyCallable(int id, ConcurrentHashMap<String,Object> inputlist, ConcurrentHashMap<String,Object> outputlist){
                ...
                kk = (Integer)OMP_inputList.get("kk");
