package PyjamaCode.TestingClauses.LastPrivate;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
 ...
 * *///#GEN#[-1]#PJ#
public class lastPrivate_positive_test2 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    /**
	 ...
	 * threadNumber
	 * *///#GEN#[-1]#PJ#
    public int parallel_for_lastPrivate(int threadNumber) {{//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#BEGIN firstprivate lastprivate reduction variables defined and initialized here
                    int OMP_WoRkShArInG_PRIVATE_i= 0;
                    ...
                    for (OMP_iterator=__omp_loop_thread_num*1; OMP_iterator<=OMP_end && 1>0; OMP_iterator=OMP_iterator+__omp_loop_num_threads*1) {
                        for (int OMP_local_iterator = OMP_iterator; OMP_local_iterator<OMP_iterator+1 && OMP_local_iterator<=OMP_end; OMP_local_iterator++){
                            ...
                            {//#GEN#[-1]#PJ#
                                OMP_WoRkShArInG_PRIVATE_i++;//#GEN#[-1]#PJ#
                                int index = Pyjama.omp_get_thread_num();//#GEN#[-1]#PJ#
                                if (index == threadNumber) {//#GEN#[-1]#PJ#
                                    try {//#GEN#[-1]#PJ#
                                        Thread.sleep(500);//#GEN#[-1]#PJ#
                                        OMP_WoRkShArInG_PRIVATE_i = threadNumber;//#GEN#[-1]#PJ#
                                    } catch (InterruptedException e) {//#GEN#[-1]#PJ#
                                        e.printStackTrace();//#GEN#[-1]#PJ#
                                    }//#GEN#[-1]#PJ#
                                }//#GEN#[-1]#PJ#
                            }if (OMP_end == OMP_local_iterator) {
                                //BEGIN lastprivate variables value set
                                i = OMP_WoRkShArInG_PRIVATE_i;
