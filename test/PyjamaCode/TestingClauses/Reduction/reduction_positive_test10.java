...
//#GEN#[-1]#PJ#
public class reduction_positive_test10 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    private int[] a = null;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public int parallel_for_reduction(int threadNumber, int n) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        a = new int[n];//#GEN#[-1]#PJ#
        int sum = 0;//#GEN#[-1]#PJ#
        int i = 0;//#GEN#[-1]#PJ#
        for (i = 0; i < n; i++) {//#GEN#[-1]#PJ#
            a[i] = i;//#GEN#[-1]#PJ#
        }//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#BEGIN firstprivate lastprivate reduction variables defined and initialized here
                    int OMP_WoRkShArInG_PRIVATE_sum = sum;
                    ...
                    for (OMP_local_iterator=OMP_Chunk_Starting_point; OMP_local_iterator<OMP_Chunk_Starting_point+OMP_Default_chunkSize_autoGenerated && OMP_Default_chunkSize_autoGenerated>0; ++OMP_local_iterator) {
                        ...
                        {//#GEN#[-1]#PJ#
                            OMP_WoRkShArInG_PRIVATE_sum = OMP_WoRkShArInG_PRIVATE_sum + a[i];//#GEN#[-1]#PJ#
                    ...
                    sum=sum+OMP_WoRkShArInG_PRIVATE_sum;
...
//#GEN#[-1]#PJ#
    public int parallel_reduction(int threadNumber) {{//#GEN#[-1]#PJ#
        ...
        inputlist__OMP_ParallelRegion_1.put("sum",sum);
        outputlist__OMP_ParallelRegion_1.put("sum",sum);
        ...
        sum = (Integer)outputlist__OMP_ParallelRegion_1.get("sum");
                        ...
                        for (int OMP_local_iterator = OMP_iterator; OMP_local_iterator<OMP_iterator+1 && OMP_local_iterator<=OMP_end; OMP_local_iterator++){
                            ...
                            {//#GEN#[-1]#PJ#
                                switch(_omp_i_2) {//#GEN#[-1]#PJ#
                                    case 0://#GEN#[-1]#PJ#
                                        {//#GEN#[-1]#PJ#
                                            OMP_WoRkShArInG_PRIVATE_sum = OMP_WoRkShArInG_PRIVATE_sum + 1;//#GEN#[-1]#PJ#
                                        }//#GEN#[-1]#PJ#
                                        break;//#GEN#[-1]#PJ#
                                    case 1://#GEN#[-1]#PJ#
                                        {//#GEN#[-1]#PJ#
