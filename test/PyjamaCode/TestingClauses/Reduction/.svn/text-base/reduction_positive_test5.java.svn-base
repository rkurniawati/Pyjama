 ...
 * 1|1=1
 * *///#GEN#[-1]#PJ#
public class reduction_positive_test5 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    /**
	 * return 10
	 * *///#GEN#[-1]#PJ#
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#BEGIN firstprivate lastprivate reduction variables defined and initialized here
                    ...
                    for (OMP_local_iterator=OMP_Chunk_Starting_point; OMP_local_iterator<OMP_Chunk_Starting_point+OMP_Default_chunkSize_autoGenerated && OMP_Default_chunkSize_autoGenerated>0; ++OMP_local_iterator) {
                        ...
                        {//#GEN#[-1]#PJ#
                            OMP_WoRkShArInG_PRIVATE_result |= (int) Math.pow(0, i);//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#GEN#[-1]#PJ#
                    ...
                    result |= (int) Math.pow(-1, index);//#GEN#[-1]#PJ#
                }
                /****User Code END***/
                //BEGIN reduction procedure
                            ...
                            {//#GEN#[-1]#PJ#
                                switch(_omp_i_2) {//#GEN#[-1]#PJ#
                                    case 0://#GEN#[-1]#PJ#
                                        {//#GEN#[-1]#PJ#
                                            int index = Pyjama.omp_get_thread_num();//#GEN#[-1]#PJ#
                                            OMP_WoRkShArInG_PRIVATE_result |= (int) Math.pow(-1, 1);//#GEN#[-1]#PJ#
                                        }//#GEN#[-1]#PJ#
                                        break;//#GEN#[-1]#PJ#
                                    case 1://#GEN#[-1]#PJ#
                                        {//#GEN#[-1]#PJ#
                                            int index = Pyjama.omp_get_thread_num();//#GEN#[-1]#PJ#
                                            OMP_WoRkShArInG_PRIVATE_result |= (int) Math.pow(-1, 2);//#GEN#[-1]#PJ#
                                        }//#GEN#[-1]#PJ#
                                        break;//#GEN#[-1]#PJ#
                                }//#GEN#[-1]#PJ#
                            }if (OMP_end == OMP_local_iterator) {
