 ...
 * True && False = False
 * *///#GEN#[-1]#PJ#
public class reduction_positive_test7 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    /**
	 * return False
	 * *///#GEN#[-1]#PJ#
    public boolean parallel_for_reduction(int threadNumber, int n) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        boolean result = true;//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#BEGIN firstprivate lastprivate reduction variables defined and initialized here
                    boolean OMP_WoRkShArInG_PRIVATE_result = result;
                    ...
                    for (OMP_local_iterator=OMP_Chunk_Starting_point; OMP_local_iterator<OMP_Chunk_Starting_point+OMP_Default_chunkSize_autoGenerated && OMP_Default_chunkSize_autoGenerated>0; ++OMP_local_iterator) {
                        ...
                        {//#GEN#[-1]#PJ#
                            OMP_WoRkShArInG_PRIVATE_result = OMP_WoRkShArInG_PRIVATE_result && false;//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public boolean parallel_reduction(int threadNumber) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        boolean result = true;//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public boolean parallel_sections_reduction(int threadNumber) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        boolean result = true;//#GEN#[-1]#PJ#
