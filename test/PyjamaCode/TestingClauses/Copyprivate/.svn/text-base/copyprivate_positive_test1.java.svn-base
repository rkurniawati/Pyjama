package PyjamaCode.TestingClauses.Copyprivate;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
public class copyprivate_positive_test1 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public int[] parallel_copyPrivate(int threadNumber) {{//#GEN#[-1]#PJ#
