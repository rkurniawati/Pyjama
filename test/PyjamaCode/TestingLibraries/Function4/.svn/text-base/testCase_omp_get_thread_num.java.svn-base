package PyjamaCode.TestingLibraries.Function4;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
public class testCase_omp_get_thread_num {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public int[] parallel_omp_get_thread_num(int threadNumber) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int[] thread = new int[threadNumber];//#GEN#[-1]#PJ#
        ...
        inputlist__OMP_ParallelRegion_0.put("thread",thread);
...
class _OMP_ParallelRegion_0{
        ...
        public _OMP_ParallelRegion_0(int thread_num, InternalControlVariables icv, ConcurrentHashMap<String, Object> inputlist, ConcurrentHashMap<String, Object> outputlist) {
            ...
            thread = (int[])OMP_inputList.get("thread");
            //#END shared variables initialised here
        }

        private void updateOutputListForSharedVars() {
            //BEGIN update outputlist
            OMP_outputList.put("thread",thread);
