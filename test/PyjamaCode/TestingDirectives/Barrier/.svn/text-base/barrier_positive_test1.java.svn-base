package PyjamaCode.TestingDirectives.Barrier;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#GEN#[-1]#PJ#
                    ...
                    array[ThreadID] = ThreadID;//#GEN#[-1]#PJ#
                    PjRuntime.setBarrier();//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
                    for (int i = 0; i < threadNumber; i++) {//#GEN#[-1]#PJ#
                        sum += array[i];//#GEN#[-1]#PJ#
                    }//#GEN#[-1]#PJ#
                    result[ThreadID] = sum;//#GEN#[-1]#PJ#
                }
                /****User Code END***/
