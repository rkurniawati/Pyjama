package PyjamaCode.TestingDirectives.Ordered;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
public class ordered_positive_test1 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public int[] parallel_ordered(int threadNumber) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadNumber);//#GEN#[-1]#PJ#
        int[] array = new int[threadNumber];//#GEN#[-1]#PJ#
        int[] counter = new int[1];//#GEN#[-1]#PJ#
        counter[0] = 0;//#GEN#[-1]#PJ#
        ...
        counter = (int[])outputlist__OMP_ParallelRegion_0.get("counter");
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#BEGIN firstprivate lastprivate reduction variables defined and initialized here
                    ...
                    for (OMP_local_iterator=OMP_Chunk_Starting_point; OMP_local_iterator<OMP_Chunk_Starting_point+OMP_Default_chunkSize_autoGenerated && OMP_Default_chunkSize_autoGenerated>0; ++OMP_local_iterator) {
                        ...
                        {//#GEN#[-1]#PJ#
                            while (PjRuntime.get_OMP_orderCursor().get() < OMP_local_iterator) {}//#GEN#[-1]#PJ#
                            {//#GEN#[-1]#PJ#
                                int index = Pyjama.omp_get_thread_num();//#GEN#[-1]#PJ#
                                PjRuntime.OMP_lock.lock();//#GEN#[-1]#PJ#
                                try {//#GEN#[-1]#PJ#
                                    {//#GEN#[-1]#PJ#
                                        array[index] = counter[0]++;//#GEN#[-1]#PJ#
                                    }} finally {//#GEN#[-1]#PJ#
                                PjRuntime.OMP_lock.unlock();//#GEN#[-1]#PJ#
                            }//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
                        }//#GEN#[-1]#PJ#
                        PjRuntime.get_OMP_orderCursor().incrementAndGet();//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
