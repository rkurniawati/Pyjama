package PyjamaCode.TestingDirectives.Master;//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
public class master_positive_test1 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public int[] parallel_master(int threadNumber) {{//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#GEN#[-1]#PJ#
                    ...
                    if (0 == Pyjama.omp_get_thread_num()) {//#GEN#[-1]#PJ#
                        {//#GEN#[-1]#PJ#
