...
*///#GEN#[-1]#PJ#
public class FreeGuiThread_positive_test2 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    private StringBuffer sb = new StringBuffer();//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    public String positive_test2() {{//#GEN#[-1]#PJ#
        sb.append(SwingUtilities.isEventDispatchThread());//#GEN#[-1]#PJ#
        try {//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
        public void run() {{//#GEN#[-1]#PJ#
            ...
            _OMP_ParallelRegion_0 _OMP_ParallelRegion_0_in = new _OMP_ParallelRegion_0(_threadNum__OMP_ParallelRegion_0=(1),icv__OMP_ParallelRegion_0,inputlist__OMP_ParallelRegion_0,outputlist__OMP_ParallelRegion_0);//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
            sb.append(SwingUtilities.isEventDispatchThread());//#GEN#[-1]#PJ#
            //#BEGIN GUI execution block//#GEN#[-1]#PJ#
            if (SwingUtilities.isEventDispatchThread()) {//#GEN#[-1]#PJ#
                {//#GEN#[-1]#PJ#
                    sb.append(SwingUtilities.isEventDispatchThread());//#GEN#[-1]#PJ#
                }}//#GEN#[-1]#PJ#
            else {//#GEN#[-1]#PJ#
    ...
    SwingUtilities.invokeAndWait(new _OMP_GuiCode_1());
} catch (InvocationTargetException e) {e.printStackTrace();}
catch (InterruptedException e) {e.printStackTrace();}
//#GEN#[-1]#PJ#
                }//#GEN#[-1]#PJ#
                //#END GUI execution block//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
            }//#GEN#[-1]#PJ#
            }
...
//#GEN#[-1]#PJ#
    ...
    SwingUtilities.invokeAndWait(new _OMP_GuiCode_0());
} catch (InvocationTargetException e) {e.printStackTrace();}
catch (InterruptedException e) {e.printStackTrace();}
//#GEN#[-1]#PJ#
                    }//#GEN#[-1]#PJ#
...
//#GEN#[-1]#PJ#
        ...
        public void runParallelCode() {
            Callable<ConcurrentHashMap<String,Object>> slaveThread = new MyCallable(0, OMP_inputList, OMP_outputList);
