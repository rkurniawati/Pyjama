...
//#GEN#[-1]#PJ#
public class loopFor_positive_test5 {//#GEN#[-1]#PJ#
//#GEN#[-1]#PJ#
    /**
	 * loopFor initialization
	 * *///#GEN#[-1]#PJ#
    public int[] parallel_loopFor(int threadCount) {{//#GEN#[-1]#PJ#
        Pyjama.omp_set_num_threads(threadCount);//#GEN#[-1]#PJ#
        int[] array = new int[1000];//#GEN#[-1]#PJ#
        ...
        class MyCallable implements Callable<ConcurrentHashMap<String,Object>> {
            ...
            public ConcurrentHashMap<String,Object> call() {
                ...
                {//#BEGIN firstprivate lastprivate reduction variables defined and initialized here
                    ...
                    int i=0;
                    int OMP_iterator = 0;
                    int OMP_end = (int)(((100 < 50 ? 0 : 100))-(100 > 50 ? 100 : 0))/(1);
                    if ((((100 < 50 ? 0 : 100))-(100 > 50 ? 100 : 0))%(1) == 0) {
                        OMP_end = OMP_end - 1;
                    }
                    ...
                    for (OMP_local_iterator=OMP_Chunk_Starting_point; OMP_local_iterator<OMP_Chunk_Starting_point+OMP_Default_chunkSize_autoGenerated && OMP_Default_chunkSize_autoGenerated>0; ++OMP_local_iterator) {
                        i = 100 > 50 ? 100 : 0 + OMP_local_iterator * (1);
                        {//#GEN#[-1]#PJ#
                            array[i] = i;//#GEN#[-1]#PJ#
