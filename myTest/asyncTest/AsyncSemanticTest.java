...
public class AsyncSemanticTest {
    ...
    public static void test() {{
        ...
        inputlist__OMP_TargetTaskRegion_2.put("c",c);
        ...
        inputlist__OMP_TargetTaskRegion_3.put("d",d);
        ...
        PjRuntime.submitTask(Thread.currentThread(), "worker1", _OMP_TargetTaskRegion_3_in);
        PjRuntime.waitTaskForFinish(_OMP_TargetTaskRegion_3_in);
        ...
        inputlist__OMP_TargetTaskRegion_4.put("e",e);
        ...
        PjRuntime.submitTask(Thread.currentThread(), "worker2", _OMP_TargetTaskRegion_4_in);
...
class test extends pj.pr.target.TargetTask{
    ...
    public static void asyncTest() {{
        ...
        PjRuntime.waitTaskForFinish(_OMP_TargetTaskRegion_5_in);
