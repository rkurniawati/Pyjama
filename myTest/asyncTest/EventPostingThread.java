...
public class EventPostingThread extends EPT {
	private AsyncGuiTest a;
	private ArrayList<Long> startTimeStamp;
	private int sleepMillis;
	private int iteration = 10;
	public EventPostingThread(AsyncGuiTest aa, int iter, ArrayList<Long> start) {
		this.a = aa;
		this.iteration = iter;
		this.startTimeStamp = start;
		this.sleepMillis = 1;
	}
	public EventPostingThread(AsyncGuiTest aa, int iter, ArrayList<Long> start, int sleepTime) {
		this.a = aa;
		this.iteration = iter;
		this.startTimeStamp = start;
