...
//��Followings are OpenMP support grammar; Xing Fan added at 2014.9.25
  ...
  final public OmpParallelConstruct OmpParallelConstruct() throws ParseException {
    ...
    body = Statement();
          {if (true) return new OmpParallelConstruct(body, dataClauseList, ifExpr, numThreads);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpParallelForConstruct OmpParallelForConstruct() throws ParseException {
    ...
    forBody = ForStatement();
          {if (true) return new OmpParallelForConstruct(forBody, dataClauseList, ifExpr, numThreads);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpParallelSectionsConstruct OmpParallelSectionsConstruct() throws ParseException {
    ...
    jj_consume_token(RBRACE);
          {if (true) return new OmpParallelSectionsConstruct(sectionList, dataClauseList, ifExpr, numThreads);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpForConstruct OmpForConstruct() throws ParseException {
    ...
    while (true) {
      ...
      case SCHEDULE:
        scheduleClause = OmpScheduleClause();
                                                      if((++schduleClauseCount)>1) {if (true) throw new RuntimeException("more than one schedule clause");}
        break;
      default:
        jj_la1[143] = jj_gen;
        jj_consume_token(-1);
    ...
    forStmt = ForStatement();
          {if (true) return new OmpForConstruct(forStmt, dataClauseList, scheduleClause, nowait, ordered);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpSectionsConstruct OmpSectionsConstruct() throws ParseException {
    ...
    jj_consume_token(RBRACE);
          {if (true) return new OmpSectionsConstruct(sectionList, dataClauseList, nowait);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpFreeguiConstruct OmpFreeguiConstruct() throws ParseException {
    ...
    case DECR:
      stmt = Statement();
                              {if (true) return new OmpFreeguiConstruct(stmt);}
      break;
    default:
      jj_la1[147] = jj_gen;
      if (jj_2_47(2)) {
        opc = OmpParallelConstruct();
         {if (true) return new OmpFreeguiConstruct(opc);}
      } else if (jj_2_48(2)) {
        opfc = OmpParallelForConstruct();
         {if (true) return new OmpFreeguiConstruct(opfc);}
      } else if (jj_2_49(2)) {
        opsc = OmpParallelSectionsConstruct();
         {if (true) return new OmpFreeguiConstruct(opsc);}
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
  ...
  final public OmpSectionConstruct OmpSectionConstruct() throws ParseException {
    ...
    jj_consume_token(SECTION);
                   line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpSectionConstruct(stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpGuiConstruct OmpGuiConstruct() throws ParseException {
    ...
    jj_consume_token(GUI);
               line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpGuiConstruct(stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpSingleConstruct OmpSingleConstruct() throws ParseException {
    ...
    jj_consume_token(SINGLE);
                  line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpSingleConstruct(stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpMasterConstruct OmpMasterConstruct() throws ParseException {
    ...
    jj_consume_token(MASTER);
                  line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpMasterConstruct(stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpCriticalConstruct OmpCriticalConstruct() throws ParseException {
    ...
    jj_consume_token(CRITICAL);
                    line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpCriticalConstruct(stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpAtomicConstruct OmpAtomicConstruct() throws ParseException {
    ...
    jj_consume_token(ATOMIC);
                  line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpAtomicConstruct(stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpBarrierDirective OmpBarrierDirective() throws ParseException {
    ...
    jj_consume_token(BARRIER);
                   line=token.beginLine; column=token.beginColumn;
         {if (true) return new OmpBarrierDirective();}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpFlushDirective OmpFlushDirective() throws ParseException {
    ...
    jj_consume_token(FLUSH);
                 line=token.beginLine; column=token.beginColumn;
         {if (true) return new OmpFlushDirective();}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpOrderedConstruct OmpOrderedConstruct() throws ParseException {
    ...
    jj_consume_token(ORDERED);
                   line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpOrderedConstruct(stmt);}
    throw new Error("Missing return statement in function");
  }
...
//��Support OpenMP Clause Statement; Xing Fan added at 2014.9.25
  final public OmpScheduleClause OmpScheduleClause() throws ParseException {
    ...
    jj_consume_token(RPAREN);
         {if (true) return new OmpScheduleClause(type, chunkSize);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpPrivateClause OmpPrivateClause() throws ParseException {
        OmpPrivateClause ret = new OmpPrivateClause();
        Expression expr;
    jj_consume_token(PRIVATE);
    jj_consume_token(LPAREN);
    expr = Expression();
  ...
  final public OmpNumthreadsClause OmpNumthreadsClause() throws ParseException {
    ...
    numExpr = Expression();
    jj_consume_token(RPAREN);
         {if (true) return new OmpNumthreadsClause(numExpr);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpIfClause OmpIfClause() throws ParseException {
    ...
    ifExpr = Expression();
    jj_consume_token(RPAREN);
         {if (true) return new OmpIfClause(ifExpr);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x48101000,0x1,0x0,0x0,0x0,0x40001000,0x8100000,0x48101000,0x100000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x4a195000,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x4a195000,0x8100000,0x2094000,0x4a195000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x0,0x0,0x0,0x0,0x0,0x42095000,0x0,0x0,0x0,0x0,0x0,0x22094000,0x6359f000,0x0,0x2094000,0x2094000,0x0,0x2094000,0x10000000,0x10000000,0x2094000,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x22094000,0x0,0x0,0x22094000,0x0,0x2094000,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x22094000,0x0,0x0,0x2094000,0x0,0x0,0x0,0x2349e000,0x0,0x2349e000,0x0,0x0,0x0,0x22094000,0x820000,0x820000,0x4000000,0x62095000,0x22094000,0x22094000,0x62095000,0x22094000,0x0,0x0,0x0,0x22094000,0x40000,0x80000000,0x80040000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x4a195000,0xa194000,0x4a195000,0x800000,0x0,0x800000,0x800000,0x800000,0x800000,0x800000,0x800000,0x0,0x800000,0x800000,0x800000,0x800000,0x0,0x2349e000,0x0,0x0,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x20,0x8899c500,0x0,0x0,0x80000,0x0,0x8899c400,0x100,0x8899c500,0x100,0x0,0x0,0x10,0x0,0x0,0x10,0x0,0x0,0xc89dc781,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc89dc781,0x100,0x40040281,0xc89dc781,0x0,0x0,0x0,0x51241a81,0x51241a81,0x0,0x0,0x0,0x4000000,0x0,0x0,0x889dc681,0x0,0x0,0x4000000,0x0,0x0,0x51241a81,0xfbffdf8b,0x80000,0x40281,0x40281,0x0,0x40281,0x200000,0x200000,0x40281,0x40040281,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x51241a81,0x0,0x0,0x51241a81,0x0,0x40281,0x0,0x0,0x0,0x11201800,0x0,0x0,0x0,0x0,0x1000800,0x0,0x10001000,0x10000000,0x51241a81,0x0,0x0,0x40281,0x0,0x0,0x0,0x73e61a8b,0x0,0x73e61a8b,0x0,0x0,0x0,0x51241a81,0x0,0x0,0