 ...
 */
   ...
   BodyDeclaration ret;
    ...
    if (jj_2_6(2)) {
      ...
      case LT:
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case OPENMP_PRAGMA:
          jj_consume_token(OPENMP_PRAGMA);
        ...
        default:
          ...
          if (jj_2_4(2147483647)) {
            ...
            case IDENTIFIER:
            case LT:
              ret = MethodDeclaration(modifier, isAsyncMethod);
              break;
            default:
              jj_la1[29] = jj_gen;
              jj_consume_token(-1);
  ...
  final public MethodDeclaration MethodDeclaration(Modifier modifier, boolean isOmpAsync) throws ParseException {
    ...
    {if (true) return new MethodDeclaration(line, column, token.endLine, token.endColumn,popJavadoc(), modifier.modifiers, modifier.annotations, typeParameters, type, name, parameters, arrayCount, throws_, block, isOmpAsync);}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  final public Statement Statement() throws ParseException {
    ...
    if (jj_2_35(2)) {
      ...
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OPENMP_PRAGMA:
        //��Support OpenMP Statement; Xing Fan added at 2014.9.25
                  ret = OpenMPStatement();
        break;
      case ASSERT:
        ret = AssertStatement();
...
//��Followings are OpenMP support grammar; Xing Fan added at 2014.9.25
  final public OpenMPStatement OpenMPStatement() throws ParseException {
        OpenMPStatement  ret = null;
    jj_consume_token(OPENMP_PRAGMA);
    if (jj_2_44(2)) {
          OmpParallelForConstruct parallelForConstruct;
      //#omp parallel needs normalisation; Xing Fan at 2014.9.29
                      parallelForConstruct = OmpParallelForConstruct();
          ret = parallelForConstruct.normalisation();
    } else if (jj_2_45(2)) {
          OmpParallelSectionsConstruct parallelSectionsConstruct;
      //#omp parallel sections needs normalisation; Xing Fan at 2014.9.29
                      parallelSectionsConstruct = OmpParallelSectionsConstruct();
          ret = parallelSectionsConstruct.normalisation();
    } else if (jj_2_46(2)) {
      ret = OmpParallelConstruct();
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case FOR:
        ret = OmpForConstruct();
        break;
      case SECTIONS:
          OmpSectionsConstruct sectionsConstruct;
        //#omp sections needs normalisation; Xing Fan at 2014.9.29
                        sectionsConstruct = OmpSectionsConstruct();
          ret = sectionsConstruct.normalisation();
        break;
      case FREEGUI:
        ret = OmpFreeguiConstruct();
        break;
      case GUI:
        ret = OmpGuiConstruct();
        break;
      case SINGLE:
          OmpSingleConstruct singleConstruct;
        //#omp single needs normalisation; Xing Fan at 2014.9.29
                        singleConstruct = OmpSingleConstruct();
          ret = singleConstruct.normalisation();
        break;
      case MASTER:
        ret = OmpMasterConstruct();
        break;
      case CRITICAL:
        ret = OmpCriticalConstruct();
        break;
      case ATOMIC:
        ret = OmpAtomicConstruct();
        break;
      case TASK:
        ret = OmpTaskConstruct();
        break;
      case TASKWAIT:
        ret = OmpTaskwaitDirective();
        break;
      case TASKCANCEL:
        ret = OmpTaskcancelDirective();
        break;
      case BARRIER:
        ret = OmpBarrierDirective();
        break;
      case FLUSH:
        ret = OmpFlushDirective();
        break;
      case ORDERED:
        ret = OmpOrderedConstruct();
        break;
      case CANCELLATION_POINT:
        ret = OmpCancellationPointDirective();
        break;
      case CANCEL:
        ret = OmpCancelDirective();
        break;
      case TARGET:
        ret = OmpTargetConstruct();
        break;
      case ASYNC_CALL:
        ret = OmpAsyncCallConstruct();
        break;
      default:
        jj_la1[135] = jj_gen;
        jj_consume_token(-1);
  ...
  final public OmpParallelConstruct OmpParallelConstruct() throws ParseException {
        Statement body = null;
        OmpDataClause dataClause = null;
        List<OmpDataClause> dataClauseList = new ArrayList<OmpDataClause>();
        int numThreadsClauseCount = 0;
        int IfClauseCount = 0;
        int defaultDataClauseCount = 0;
        OmpNumthreadsClause numThreads = null;
        OmpIfClause ifExpr = null;
        OmpNeglectExceptionClause exceptionClause = null;
        int line;
        int column;
    ...
    while (true) {
      ...
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NUMTHREADS:
        numThreads = OmpNumthreadsClause();
                                                         if((++numThreadsClauseCount)>1) {if (true) throw new ParseException("Pyjama Parsing Error: More than one num_threads() clause found");}
        break;
      case IF:
        ifExpr = OmpIfClause();
                                                         if((++IfClauseCount)>1) {if (true) throw new ParseException("Pyjama Parsing Error: More than one if() clause found");}
        break;
      case NEGLECT:
        exceptionClause = OmpNeglectExceptionClause();

        break;
      case PRIVATE:
      case FIRSTPRIVATE:
        dataClause = OmpPrivateDataClause();
                                                         dataClauseList.add(dataClause);
        break;
      case SHARED:
        dataClause = OmpSharedDataClause();
                                                         dataClauseList.add(dataClause);
        break;
      case LASTPRIVATE:
      ...
      case _DEFAULT:
        dataClause = OmpDefaultDataClause();
                                                         if((++defaultDataClauseCount)>1) {if (true) throw new ParseException("Pyjama Parsing Error: More than one default clause found");}
        break;
      default:
        jj_la1[137] = jj_gen;
        jj_consume_token(-1);
    ...
    body = Statement();
          {if (true) return new OmpParallelConstruct(line, column, token.endLine, token.endColumn, body, dataClauseList, ifExpr, numThreads, exceptionClause);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpParallelForConstruct OmpParallelForConstruct() throws ParseException {
        ...
        int IfClauseCount = 0;
        int defaultDataClauseCount = 0;
        int schduleClauseCount = 0;
        OmpNumthreadsClause numThreads = null;
        OmpIfClause ifExpr = null;
        OmpNeglectExceptionClause exceptionClause = null;
        OmpScheduleClause scheduleClause = null;
    ...
    while (true) {
      ...
      case NUMTHREADS:
        numThreads = OmpNumthreadsClause();
                                                         if((++numThreadsClauseCount)>1) {if (true) throw new RuntimeException("more than one num_threads() clause");}
        break;
      case IF:
        ifExpr = OmpIfClause();
                                                         if((++IfClauseCount)>1) {if (true) throw new RuntimeException("more than one if() clause");}
        break;
      case NEGLECT:
        exceptionClause = OmpNeglectExceptionClause();
      ...
      case _DEFAULT:
        ...
        break;
      case SCHEDULE:
        scheduleClause = OmpScheduleClause();
                                                         if((++schduleClauseCount)>1) {if (true) throw new RuntimeException("Pyjama Parsing Error: More than one schedule clause");}
        break;
      default:
        jj_la1[139] = jj_gen;
        jj_consume_token(-1);
    ...
    forBody = ForStatement();
          {if (true) return new OmpParallelForConstruct(line, column, token.endLine, token.endColumn, forBody, dataClauseList, scheduleClause, ifExpr, numThreads, exceptionClause, ordered);}
    throw new Error("Missing return statement in function");
  }

  final public OmpParallelSectionsConstruct OmpParallelSectionsConstruct() throws ParseException {
        OmpSectionConstruct sectionBlock = null;

        ArrayList<OmpSectionConstruct> sectionList = new ArrayList<OmpSectionConstruct>();
        OmpDataClause dataClause = null;
        List<OmpDataClause> dataClauseList = new ArrayList<OmpDataClause>();
        int numThreadsClauseCount = 0;
        int IfClauseCount = 0;
    ...
    while (true) {
      ...
      jj_consume_token(OPENMP_PRAGMA);
      sectionBlock = OmpSectionConstruct();
                                                                      sectionList.add(sectionBlock);
    }
    jj_consume_token(RBRACE);
          {if (true) return new OmpParallelSectionsConstruct(line, column, token.endLine, token.endColumn, sectionList, dataClauseList, ifExpr, numThreads, exceptionClause);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpForConstruct OmpForConstruct() throws ParseException {
    ...
    while (true) {
      ...
      case SHARED:
        dataClause = OmpSharedDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: shared data clause cannot appear in for directive");}
        break;
      case LASTPRIVATE:
        dataClause = OmpLastprivateDataClause();
                                                         dataClauseList.add(dataClause);
      ...
      case _DEFAULT:
        dataClause = OmpDefaultDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: default clause cannot appear in for directive");}
        break;
      case SCHEDULE:
        scheduleClause = OmpScheduleClause();
                                                         if((++schduleClauseCount)>1) {if (true) throw new RuntimeException("Pyjama Parsing Error: More than one schedule clause");}
    ...
    forStmt = ForStatement();
          {if (true) return new OmpForConstruct(line, column, token.endLine, token.endColumn, forStmt, dataClauseList, scheduleClause, exceptionClause, nowait, ordered);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpSectionsConstruct OmpSectionsConstruct() throws ParseException {
    ...
    while (true) {
      ...
      case SHARED:
        dataClause = OmpSharedDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: shared data clause cannot appear in sections directive");}
        break;
      case LASTPRIVATE:
        dataClause = OmpLastprivateDataClause();
                                                         dataClauseList.add(dataClause);
      ...
      case _DEFAULT:
        dataClause = OmpDefaultDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: default clause cannot appear in sections directive");}
        break;
      case NEGLECT:
        exceptionClause = OmpNeglectExceptionClause();
    ...
    jj_consume_token(RBRACE);
          {if (true) return new OmpSectionsConstruct(line, column, token.endLine, token.endColumn, sectionList, dataClauseList, exceptionClause, nowait);}
    throw new Error("Missing return statement in function");
  }

  final public OmpParallelConstruct OmpFreeguiConstruct() throws ParseException {
        Statement stmt = null;
        OmpFreeguiConstruct freeguiConstruct = null;
        OmpParallelConstruct opc = null;
        OmpParallelForConstruct opfc = null;
        OmpParallelSectionsConstruct opsc = null;
        int line;
        int column;
    jj_consume_token(FREEGUI);
               line=token.beginLine; column=token.beginColumn;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ASSERT:
    case BOOLEAN:
    ...
    case DECR:
      stmt = Statement();
         freeguiConstruct = new OmpFreeguiConstruct(line, column, token.endLine, token.endColumn, stmt);
      break;
    default:
      jj_la1[148] = jj_gen;
      if (jj_2_47(2)) {
        opc = OmpParallelConstruct();
         freeguiConstruct = new OmpFreeguiConstruct(line, column, token.endLine, token.endColumn, opc);
      } else if (jj_2_48(2)) {
        opfc = OmpParallelForConstruct();
         freeguiConstruct = new OmpFreeguiConstruct(line, column, token.endLine, token.endColumn, opfc);
      } else if (jj_2_49(2)) {
        opsc = OmpParallelSectionsConstruct();
         freeguiConstruct = new OmpFreeguiConstruct(line, column, token.endLine, token.endColumn, opsc);
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
    }
   {if (true) return freeguiConstruct.normalisation();}
    throw new Error("Missing return statement in function");
  }

  final public OmpSectionConstruct OmpSectionConstruct() throws ParseException {
        Statement stmt = null;
        int line;
        int column;
    jj_consume_token(SECTION);
                   line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpSectionConstruct(line, column, token.endLine, token.endColumn, stmt);}
    throw new Error("Missing return statement in function");
  }

  final public OmpGuiConstruct OmpGuiConstruct() throws ParseException {
        Statement stmt = null;
        boolean nowait = false;
        int line;
        int column;
    ...
    default:
      ...
      ;
                      ...
                      nowait = true;
    stmt = Statement();
         {if (true) return new OmpGuiConstruct(line, column, token.endLine, token.endColumn, stmt, nowait);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpSingleConstruct OmpSingleConstruct() throws ParseException {
    ...
    while (true) {
      ...
      case FIRSTPRIVATE:
        ...
        break;
      case COPYPRIVATE:
        dataClause = OmpCopyprivateDataClause();
                                                         dataClauseList.add(dataClause);
        break;
      case SHARED:
        dataClause = OmpSharedDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: shared data clause cannot appear in single directive");}
        break;
      case LASTPRIVATE:
        dataClause = OmpLastprivateDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: lastprivate data clause cannot appear in single directive");}
        break;
      case REDUCTION:
        dataClause = OmpReductionDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: reduction data clause cannot appear in single directive");}
        break;
      case _DEFAULT:
        dataClause = OmpDefaultDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: default clause cannot appear in single directive");}
        break;
      default:
        jj_la1[151] = jj_gen;
        jj_consume_token(-1);
    ...
    stmt = Statement();
         {if (true) return new OmpSingleConstruct(line, column, token.endLine, token.endColumn, stmt, dataClauseList, nowait);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpMasterConstruct OmpMasterConstruct() throws ParseException {
    ...
    jj_consume_token(MASTER);
                  line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpMasterConstruct(line, column, token.endLine, token.endColumn, stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpCriticalConstruct OmpCriticalConstruct() throws ParseException {
    ...
    stmt = Statement();
         {if (true) return new OmpCriticalConstruct(line, column, token.endLine, token.endColumn, stmt, identifier);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpAtomicConstruct OmpAtomicConstruct() throws ParseException {
    ...
    jj_consume_token(ATOMIC);
                  line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpAtomicConstruct(line, column, token.endLine, token.endColumn, stmt);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpTaskConstruct OmpTaskConstruct() throws ParseException {
    ...
    while (true) {
      ...
      case LASTPRIVATE:
        dataClause = OmpLastprivateDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: Lastprivate data clause cannot appear in task directive");}
        break;
      case REDUCTION:
        dataClause = OmpReductionDataClause();
                                                         {if (true) throw new ParseException("Pyjama Parsing Error: Reduction data clause cannot appear in task directive");}
        break;
      case _DEFAULT:
        dataClause = OmpDefaultDataClause();
                                                         if((++defaultDataClauseCount)>1) {if (true) throw new ParseException("Pyjama Parsing Error: More than one default clause found");}
    ...
    stmt = Statement();
         {if (true) return new OmpTaskConstruct(line, column, token.endLine, token.endColumn, stmt, dataClauseList, ifExpr);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpTaskwaitDirective OmpTaskwaitDirective() throws ParseException {
    ...
    default:
      ...
      ;
         ...
         {if (true) return new OmpTaskwaitDirective(line, column, token.endLine, token.endColumn, (tag==null)?null:tag.toString(), ifExpr);}
    throw new Error("Missing return statement in function");
  }

  final public OmpTaskcancelDirective OmpTaskcancelDirective() throws ParseException {
        int line;
        int column;
        NameExpr tag = null;
        OmpIfClause ifExpr = null;
    jj_consume_token(TASKCANCEL);
                      line=token.beginLine; column=token.beginColumn;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LPAREN:
      jj_consume_token(LPAREN);
    ...
    default:
      ...
      ;
         ...
         {if (true) return new OmpTaskcancelDirective(line, column, token.endLine, token.endColumn, (tag==null)?null:tag.toString(), ifExpr);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpBarrierDirective OmpBarrierDirective() throws ParseException {
        int line;
        int column;
    jj_consume_token(BARRIER);
                   line=token.beginLine; column=token.beginColumn;
         {if (true) return new OmpBarrierDirective(line, column, token.endLine, token.endColumn);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpFlushDirective OmpFlushDirective() throws ParseException {
    ...
    jj_consume_token(FLUSH);
                 line=token.beginLine; column=token.beginColumn;
         {if (true) return new OmpFlushDirective(line, column, token.endLine, token.endColumn);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpOrderedConstruct OmpOrderedConstruct() throws ParseException {
    ...
    jj_consume_token(ORDERED);
                   line=token.beginLine; column=token.beginColumn;
    stmt = Statement();
         {if (true) return new OmpOrderedConstruct(line, column, token.endLine, token.endColumn, stmt);}
    throw new Error("Missing return statement in function");
  }

//��Followings are Pyjama extionsion of OpenMP for thread cancellation; Xing Fan added at 2015.1.8
  final public OmpCancellationPointDirective OmpCancellationPointDirective() throws ParseException {
        int line;
        int column;
        OmpCancellationPointDirective.Region region = null;
    jj_consume_token(CANCELLATION_POINT);
                              line=token.beginLine; column=token.beginColumn;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PARALLEL:
      jj_consume_token(PARALLEL);
                                  region = OmpCancellationPointDirective.Region.Parallel;
      break;
    case FOR:
      jj_consume_token(FOR);
                                  region = OmpCancellationPointDirective.Region.For;
      break;
    case SECTIONS:
      jj_consume_token(SECTIONS);
                                  region = OmpCancellationPointDirective.Region.Sections;
      break;
    case TASKGROUP:
      jj_consume_token(TASKGROUP);
                                  region = OmpCancellationPointDirective.Region.Taskgroup;
      break;
    case TASK:
      jj_consume_token(TASK);
                          region = OmpCancellationPointDirective.Region.CurrentTask;
      break;
    default:
      jj_la1[158] = jj_gen;
      jj_consume_token(-1);
      throw new ParseException();
         ...
         {if (true) return new OmpCancellationPointDirective(line, column, token.endLine, token.endColumn, region);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpCancelDirective OmpCancelDirective() throws ParseException {
        int line;
        int column;
        OmpCancelDirective.Region region = null;
        OmpCancelDirective.ThreadAffiliate affiliate = null;
        OmpIfClause ifExpr = null;
        NameExpr exception = null;
    jj_consume_token(CANCEL);
                  line=token.beginLine; column=token.beginColumn;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PARALLEL:
      jj_consume_token(PARALLEL);
                                  region = OmpCancelDirective.Region.Parallel;
      break;
    case FOR:
      jj_consume_token(FOR);
                                  region = OmpCancelDirective.Region.For;
      break;
    case SECTIONS:
      jj_consume_token(SECTIONS);
                                  region = OmpCancelDirective.Region.Sections;
      break;
    case TASKGROUP:
      jj_consume_token(TASKGROUP);
                                  region = OmpCancelDirective.Region.Taskgroup;
      break;
    default:
      jj_la1[159] = jj_gen;
      jj_consume_token(-1);
    ...
    case LOCAL:
      jj_consume_token(LOCAL);
                                  affiliate = OmpCancelDirective.ThreadAffiliate.Local;
      break;
    case GLOBAL:
      jj_consume_token(GLOBAL);
                                  affiliate = OmpCancelDirective.ThreadAffiliate.Global;
      break;
    default:
      jj_la1[160] = jj_gen;
      jj_consume_token(-1);
    ...
    default:
      ...
      ;
         ...
         {if (true) return new OmpCancelDirective(line, column, token.endLine, token.endColumn, region, affiliate, ifExpr, exception);}
    throw new Error("Missing return statement in function");
  }

//��Followings are Pyjama extionsion of OpenMP for asynchronous execution of task, using virtual target; Xing Fan added at 2015.6.16
  final public OmpTargetConstruct OmpTargetConstruct() throws ParseException {
        int line;
        int column;
        int waitTypeClauseCount = 0;
        int IfClauseCount = 0;
        int defaultDataClauseCount = 0;
        int onCancelCallbackCount = 0;
        //waitType: we set the default is wait, which means encoutering thread blocks until the target code is finished. //Xing Fan at 2015.12.1
        OmpTargetConstruct.ExecutionType waitType = OmpTargetConstruct.ExecutionType.Wait;
        OmpDataClause dataClause = null;
        List<OmpDataClause> dataClauseList = new ArrayList<OmpDataClause>();
        OmpIfClause ifExpr = null;
        boolean isVirtual = true;
        NameExpr targetName = null;
        NameExpr taskName = null;
        MethodCallExpr onCancelCallback = null;
        Statement body = null;
    ...
    while (true) {
      ...
      case NOWAIT:
        jj_consume_token(NOWAIT);
                          waitType = OmpTargetConstruct.ExecutionType.NoWait; if((++waitTypeClauseCount)>1) {if (true) throw new RuntimeException("more than one wait clause");}
        break;
      case AWAIT:
        jj_consume_token(AWAIT);
                          waitType = OmpTargetConstruct.ExecutionType.Await; if((++waitTypeClauseCount)>1) {if (true) throw new RuntimeException("more than one wait clause");}
        break;
      case NAMEAS:
        jj_consume_token(NAMEAS);
        jj_consume_token(LPAREN);
        taskName = Name();
        jj_consume_token(RPAREN);
                          waitType = OmpTargetConstruct.ExecutionType.NoWait; if((++waitTypeClauseCount)>1) {if (true) throw new RuntimeException("more than one wait clause");}
        break;
      case ON_CANCEL:
        jj_consume_token(ON_CANCEL);
        jj_consume_token(LPAREN);
        onCancelCallback = OmpMethodCall();
        jj_consume_token(RPAREN);
                                                                         if((++onCancelCallbackCount)>1) {if (true) throw new RuntimeException("more than one on_cancel clause");}
        break;
      default:
        jj_la1[165] = jj_gen;
        jj_consume_token(-1);
    ...
    body = Statement();
          {if (true) return new OmpTargetConstruct(line, column, token.endLine, token.endColumn, body, isVirtual, targetName, dataClauseList, ifExpr, waitType, taskName, onCancelCallback);}
    throw new Error("Missing return statement in function");
  }

//��Followings are Pyjama extionsion of OpenMP for asynchronous function call; Xing Fan added at 2015.4.22
  final public OmpAsyncCallConstruct OmpAsyncCallConstruct() throws ParseException {
        int line;
        int column;
        OmpFunctionCallDeclaration functionDeclaration = null;
        Statement body = null;
        ArrayList<OmpFunctionCallDeclaration> functionList = new ArrayList<OmpFunctionCallDeclaration>();
    jj_consume_token(ASYNC_CALL);
                      line=token.beginLine; column=token.beginColumn;
    jj_consume_token(LPAREN);
    functionDeclaration = OmpFunctionCallDeclaration();
    ...
    jj_consume_token(RPAREN);
    body = Statement();
         {if (true) return new OmpAsyncCallConstruct(line, column, token.endLine, token.endColumn, functionList, body);}
    throw new Error("Missing return statement in function");
  }

  final public OmpFunctionCallDeclaration OmpFunctionCallDeclaration() throws ParseException {
        Type type;
        String name;
        List parameters;
    ...
    parameters = FormalParameters();
    {if (true) return new OmpFunctionCallDeclaration(line, column, token.endLine, token.endColumn, type, name, parameters);}
    throw new Error("Missing return statement in function");
  }

  final public MethodCallExpr OmpMethodCall() throws ParseException {
        String name;
        List args;
        int line = token.beginLine;
        int column = token.beginColumn;
    ...
    args = Arguments();
    {if (true) return new MethodCallExpr(line, column, token.endLine, token.endColumn, null, null, name, args);}
    throw new Error("Missing return statement in function");
  }

//��Support OpenMP Clause Statement; Xing Fan added at 2014.9.25
  final public OmpScheduleClause OmpScheduleClause() throws ParseException {
    ...
    case STATIC:
      jj_consume_token(STATIC);
                                  type = OmpScheduleClause.Type.Static;
      break;
    case DYNAMIC:
      jj_consume_token(DYNAMIC);
                                  type = OmpScheduleClause.Type.Dynamic;
      break;
    case GUIDED:
      jj_consume_token(GUIDED);
                                  type = OmpScheduleClause.Type.Guided;
      break;
    case RUNTIME:
      jj_consume_token(RUNTIME);
                                  type = OmpScheduleClause.Type.Runtime;
      break;
    case AUTO:
      jj_consume_token(AUTO);
                                  type = OmpScheduleClause.Type.Auto;
      break;
    default:
      jj_la1[169] = jj_gen;
      jj_consume_token(-1);
    ...
    jj_consume_token(RPAREN);
         {if (true) return new OmpScheduleClause(line, column, token.endLine, token.endColumn, type, chunkSize);}
    throw new Error("Missing return statement in function");
  }

  final public OmpDataClause OmpDataClause() throws ParseException {
        OmpDataClause ret = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PRIVATE:
    case FIRSTPRIVATE:
      ret = OmpPrivateDataClause();
      break;
    case SHARED:
      ret = OmpSharedDataClause();
      break;
    case LASTPRIVATE:
      ret = OmpLastprivateDataClause();
      break;
    case REDUCTION:
      ret = OmpReductionDataClause();
      break;
    case COPYPRIVATE:
      ret = OmpCopyprivateDataClause();
      break;
    case _DEFAULT:
      ret = OmpDefaultDataClause();
      break;
    default:
      jj_la1[171] = jj_gen;
      jj_consume_token(-1);
  ...
  final public OmpPrivateDataClause OmpPrivateDataClause() throws ParseException {
        OmpPrivateDataClause ret = new OmpPrivateDataClause();
        Expression expr;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PRIVATE:
      jj_consume_token(PRIVATE);
    ...
    default:
      ...
      throw new ParseException();
                                      ...
                                      ret.setBeginLine(token.beginLine); ret.setBeginColumn(token.beginColumn);
    jj_consume_token(LPAREN);
    expr = Expression();
    ...
    jj_consume_token(RPAREN);
         ret.setEndLine(token.endLine); ret.setEndColumn(token.endColumn); {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }

  final public OmpSharedDataClause OmpSharedDataClause() throws ParseException {
        OmpSharedDataClause ret = new OmpSharedDataClause();
        Expression expr;
  ...
  final public OmpLastprivateDataClause OmpLastprivateDataClause() throws ParseException {
        OmpLastprivateDataClause ret = new OmpLastprivateDataClause();
        Expression expr;
    jj_consume_token(LASTPRIVATE);
                       ret.setBeginLine(token.beginLine); ret.setBeginColumn(token.beginColumn);
    jj_consume_token(LPAREN);
    expr = Expression();
                             ret.addArgument(expr);
  ...
  final public OmpReductionDataClause OmpReductionDataClause() throws ParseException {
        OmpReductionDataClause ret = new OmpReductionDataClause();
        Expression expr;
        OmpReductionOperator operator;
    jj_consume_token(REDUCTION);
                     ret.setBeginLine(token.beginLine); ret.setBeginColumn(token.beginColumn);
    jj_consume_token(LPAREN);
    operator = OmpReductionOperator();
    jj_consume_token(COLON);
    expr = Name();
                                                             ret.addArgument(operator, expr);
    label_64:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
  ...
  final public OmpCopyprivateDataClause OmpCopyprivateDataClause() throws ParseException {
        OmpCopyprivateDataClause ret = new OmpCopyprivateDataClause();
        Expression expr;
    jj_consume_token(COPYPRIVATE);
                       ret.setBeginLine(token.beginLine); ret.setBeginColumn(token.beginColumn);
    jj_consume_token(LPAREN);
    expr = Expression();
                              ret.addArgument(expr);
  ...
  final public OmpDefaultDataClause OmpDefaultDataClause() throws ParseException {
        OmpDefaultDataClause ret = new OmpDefaultDataClause();
    jj_consume_token(_DEFAULT);
                    ret.setBeginLine(token.beginLine); ret.setBeginColumn(token.beginColumn);
    jj_consume_token(LPAREN);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SHARED:
      jj_consume_token(SHARED);
                   ret.setPolicy(OmpDefaultDataClause.Policy.Shared);
      break;
    case NONE:
      jj_consume_token(NONE);
                   ret.setPolicy(OmpDefaultDataClause.Policy.None);
      break;
    default:
      jj_la1[178] = jj_gen;
      jj_consume_token(-1);
  ...
  final public OmpNumthreadsClause OmpNumthreadsClause() throws ParseException {
        ...
        int line;
        int column;
    jj_consume_token(NUMTHREADS);
                       line=token.beginLine; column=token.beginColumn;
    jj_consume_token(LPAREN);
    numExpr = Expression();
    jj_consume_token(RPAREN);
         {if (true) return new OmpNumthreadsClause(line, column, token.endLine, token.endColumn, numExpr);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public OmpIfClause OmpIfClause() throws ParseException {
    ...
    ifExpr = Expression();
    jj_consume_token(RPAREN);
         {if (true) return new OmpIfClause(line, column, token.endLine, token.endColumn, ifExpr);}
    throw new Error("Missing return statement in function");
  }

  final public OmpReductionOperator OmpReductionOperator() throws ParseException {
        OmpReductionOperator op = null;
        NameExpr userDefined = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PLUS:
      jj_consume_token(PLUS);
                op = new OmpReductionOperator(OmpReductionOperator.Operator.Plus);
      break;
    case STAR:
      jj_consume_token(STAR);
                op = new OmpReductionOperator(OmpReductionOperator.Operator.Mult);
      break;
    case MINUS:
      jj_consume_token(MINUS);
                op = new OmpReductionOperator(OmpReductionOperator.Operator.Minus);
      break;
    case BIT_AND:
      jj_consume_token(BIT_AND);
                op = new OmpReductionOperator(OmpReductionOperator.Operator.BitAND);
      break;
    case BIT_OR:
      jj_consume_token(BIT_OR);
                op = new OmpReductionOperator(OmpReductionOperator.Operator.BitOR);
      break;
    case XOR:
      jj_consume_token(XOR);
                op = new OmpReductionOperator(OmpReductionOperator.Operator.BitXOR);
      break;
    case SC_AND:
      jj_consume_token(SC_AND);
                 op = new OmpReductionOperator(OmpReductionOperator.Operator.LogAND);
      break;
    case SC_OR:
      jj_consume_token(SC_OR);
  ...
  final public OmpNeglectExceptionClause OmpNeglectExceptionClause() throws ParseException {
        OmpNeglectExceptionClause ret = new OmpNeglectExceptionClause();
        Expression excpetionName;
    jj_consume_token(NEGLECT);
                   ret.setBeginLine(token.beginLine); ret.setBeginColumn(token.beginColumn);
    jj_consume_token(LPAREN);
    excpetionName = Name();
                                ret.addException(excpetionName);
    label_66:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
  ...
  private boolean jj_3R_255() {
    if (jj_scan_token(NEGLECT)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_3R_110()) return true;
    Token xsp;
    while (true) {
  ...
  private boolean jj_3R_253() {
    if (jj_scan_token(NUMTHREADS)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_3R_92()) return true;
    if (jj_scan_token(RPAREN)) return true;
    return false;
  ...
  private boolean jj_3R_448() {
    if (jj_scan_token(ASYNC_CALL)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_3R_485()) return true;
    Token xsp;
    while (true) {
  ...
  private boolean jj_3R_551() {
    if (jj_scan_token(ON_CANCEL)) return true;
    if (jj_scan_token(LPAREN)) return true;
  ...
  private boolean jj_3R_550() {
    if (jj_scan_token(NAMEAS)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_3R_110()) return true;
    if (jj_scan_token(RPAREN)) return true;
    return false;
  ...
  private boolean jj_3R_445() {
    if (jj_scan_token(CANCELLATION_POINT)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_469()) {
    jj_scanpos = xsp;
  ...
  private boolean jj_3R_441() {
    if (jj_scan_token(TASKCANCEL)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_433() {
    if (jj_scan_token(FREEGUI)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_462()) {
    jj_scanpos = xsp;
  ...
  private boolean jj_3R_461() {
    if (jj_scan_token(OPENMP_PRAGMA)) return true;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x48101000,0x1,0x0,0x0,0x0,0x40001000,0x8100000,0x48101000,0x100000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x4a195000,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x4a195000,0x0,0x8100000,0x2094000,0x4a195000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x0,0x0,0x0,0x0,0x0,0x42095000,0x0,0x0,0x0,0x0,0x0,0x22094000,0x6359f000,0x0,0x2094000,0x2094000,0x0,0x2094000,0x10000000,0x10000000,0x2094000,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x22094000,0x0,0x0,0x22094000,0x0,0x2094000,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x22094000,0x0,0x0,0x2094000,0x0,0x0,0x0,0x2349e000,0x0,0x2349e000,0x0,0x0,0x0,0x22094000,0x820000,0x820000,0x4000000,0x62095000,0x22094000,0x22094000,0x62095000,0x22094000,0x0,0x0,0x0,0x22094000,0x40000,0x80000000,0x80040000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x4a195000,0xa194000,0x4a195000,0x800000,0x0,0x800000,0x800000,0x800000,0x800000,0x800000,0x800000,0x0,0x800000,0x800000,0x800000,0x800000,0x0,0x2349e000,0x0,0x800000,0x800000,0x800000,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800000,0x800000,0x0,0x0,0x0,0x0,0x0,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x20,0x1099c500,0x0,0x0,0x80000,0x0,0x1099c400,0x100,0x1099c500,0x100,0x0,0x0,0x10,0x0,0x0,0x10,0x0,0x0,0x909dc781,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x909dc781,0x0,0x100,0x80040281,0x909dc781,0x0,0x0,0x0,0xa1241a81,0xa1241a81,0x0,0x0,0x0,0x8000000,0x0,0x0,0x109dc681,0x0,0x0,0x8000000,0x0,0x0,0xa1241a81,0xf3ffdf8b,0x80000,0x40281,0x40281,0x0,0x40281,0x200000,0x200000,0x40281,0x80040281,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa1241a81,0x0,0x0,0xa1241a81,0x0,0x40281,0x0,0x0,0x0,0x21201800,0x0,0x0,0x0,0x0,0x1000800,0x0,0x20001000,0x20000000,0xa1241a81,0x0,0x0,0x40281,0x0,0x0,0x0,0xe3e61a8b,0x0,0xe3e61a8b,0x0,0x0,0x0,0xa1241a81,0x0,0x0,0x0,0xb1bdde81,0xa1241a81,0xa1241a81,0xb1bdde81,0xa1241a81,0x0,0x0,0x0,0xa1241a81,0x0,0x0,0x0,0x0,0x0,0x0,0xa1241a81,0xa1241a81,0x0,0x109dc781,0x40381,0x109dc781,0x0,0x2,0x4004008,0x4004008,0x4004008,0x4004008,0x4004008,0x4004008,0x0,0x4004000,0x4004000,0x4004000,0x4004000,0x0,0xe3e61a8b,0x0,0x4000,0x4000,0x4008,0x4008,0x0,0x8,0x0,0x8,0x2,0x2,0x0,0x8,0x2000000,0x0,0x4008,0x4008,0x0,0x0,0x0,0x80000,0x0,0x4000,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x1,0x0,0x0,0x0,0x0,0x1,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x5,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x5,0x4,0x0,0x0,0x5,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x7,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6,0x0,0x6,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x1,0x0,0x43ec0e00,0x80000170,0x80000170,0x80042170,0x80042170,0x80000170,0x80000170,0x4,0x4042170,0x4042170,0x4000170,0x4000170,0x4,0x6,0x4000000,0x4000170,0x4000170,0x170,0x170,0x0,0x0,0x0,0x0,0x80008,0x80008,0x0,0x0,0x0,0x400,0x1c000170,0x1c000170,0x0,0x0,0x0,0x3c000,0x0,0x170,0x10,0x0,0x0,0x0,0x0,0x0,0xc0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x0,0x21000000,0x0,0x0,0x8000000,0x20000000,0x0,0x0,0x0,0x21000000,0x0,0x0,0x1000000,0x1000000,0x0,0x0,0x80000000,0x29c23000,0x29c23000,0x0,0x0,0x80000000,0x0,0x20000000,0x0,0x1000000,0x0,0x0,0x0,0x0,0x0,0x9c23000,0x29c23000,0x0,0x0,0x1000000,0x0,0x1000000,0x0,0x0,0x0,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x9c23000,0x0,0x0,0x9c23000,0x0,0x1000000,0x0,0x8000000,0x8000000,0x8c23000,0x1000000,0x0,0x0,0x8000000,0x0,0x80000000,0xc23000,0x0,0x9c23000,0x0,0x0,0x0,0x1000000,0x80000000,0x80000000,0x29c23000,0x0,0x29c23000,0x0,0x0,0x0,0x9c23000,0x0,0x0,0x0,0x9c23000,0x9c23000,0x9c23000,0x9c23000,0x9c23000,0x0,0x1000000,0x1000000,0x9c23000,0x0,0x0,0x0,0x0,0x1000000,0x0,0x29c23000,0x29c23000,0x0,0x1000000,0x1000000,0x1000000,0x0,0x8d6,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x29c23000,0x0,0x1,0x1,0x0,0x0,0x8000000,0x0,0x8000000,0x0,0x30,0x20,0x300,0x0,0x0,0x1000000,0x8,0x8,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x12,0x0,0x10,0x0,0x8,0x10,0x10,0x12,0x0,0x40,0x0,0x0,0x4,0x4,0x0,0x10,0x4,0x52,0x2,0x10,0x0,0x0,0x4,0x0,0x800000,0x52,0x0,0x10,0x40,0x52,0x4,0x20,0x0,0x1e0180,0x1e0180,0x4,0x40,0x0,0x0,0x2,0x4,0x10,0x0,0x40,0x0,0x40,0x40,0x40,0x60012,0x0,0x0,0x0,0x4,0x200,0x0,0x0,0x0,0x0,0x4,0xf0000020,0x200,0x8000,0x10000,0x1000000,0x2000000,0x800000,0x4800,0x4800,0x0,0x3040,0x3040,0x8000000,0x180000,0x180000,0x4600000,0x4600000,0x180000,0x1e0180,0x180,0x180,0x0,0x60000,0x0,0x40,0x0,0x0,0x0,0x0,0x8,0x40,0x0,0x0,0x8,0x0,0x0,0x1e0180,0x4,0x40,0x0,0x40,0x0,0x0,0x60002,0x400,0x60002,0x4,0xf0060020,0xf0060020,0x60000,0x0,0x0,0x0,0x1e0190,0x1e0180,0x1e0180,0x1e0192,0x1e0180,0x4,0x0,0x0,0x1e0180,0x0,0x0,0x0,0x10,0x0,0x4,0x1e0190,0x1e0190,0x4,0x12,0x10,0x12,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x60002,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x8,0x8,0x0,0x4,0x0,0x0,0x4,0x4,0x4,0x4,0x4,0x0,0x3b98000,0x4,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x0,0x0,0x800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7f,0x7f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
