...
public class OmpTaskConstruct extends OpenMPStatement{
	...
	public OmpTaskConstruct(int beginLine, int beginColumn, int endLine, int endColumn, 
			Statement statement, 
			List<OmpDataClause> dataClausesList, 
			OmpIfClause ifExpr){
