...
public class OmpSharedDataClause extends OmpDataClause{
	...
	public void printSharedVariableDefination(OpenMPStatement n, SourcePrinter printer) {
	...
	public void printSharedVariableInitialisation(OpenMPStatement n, SourcePrinter printer) {
		HashMap<String, String> args = this.getArgsTypes(n);
		for (String varName: args.keySet()) {
			String varType = args.get(varName);
			if (DataClauseHandlerUtils.isPrimitiveType(varType)) {
