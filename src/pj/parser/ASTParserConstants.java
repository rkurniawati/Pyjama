...
public interface ASTParserConstants {
  ...
  /** RegularExpression Id. */
  int DECIMAL_FLOATING_POINT_LITERAL = 112;
  /** RegularExpression Id. */
  int DECIMAL_EXPONENT = 113;
  /** RegularExpression Id. */
  int HEXADECIMAL_FLOATING_POINT_LITERAL = 114;
  /** RegularExpression Id. */
  int HEXADECIMAL_EXPONENT = 115;
  /** RegularExpression Id. */
